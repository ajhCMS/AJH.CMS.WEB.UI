...
namespace AJH.CMS.WEB.UI.Admin.Services
{
    ...
    public class ArticleService : System.Web.Services.WebService
    {
        ...
        public AjaxControlToolkit.CascadingDropDownNameValue[] GetDropDownArticleType(string knownCategoryValues, string category)
        {
            Dictionary<string, int> articleTypes = CMSWebHelper.GetEnumDataSource(Resources.CMSSetupResource.ResourceManager, typeof(CMSEnums.ArticleType));
