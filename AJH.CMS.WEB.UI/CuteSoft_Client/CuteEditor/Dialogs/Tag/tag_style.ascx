...
var OxOde8b=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOde8b[1],true)[OxOde8b[0]]=function (){if(event[OxOde8b[2]]){alert(element[OxOde8b[3]].cssText);} ;} ;
</script>
