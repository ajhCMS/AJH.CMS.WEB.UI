...
namespace AJH.CMS.Core.Data
{
    internal static class ProductDataMapper
    {
        ...
        internal static List<Product> GetProductsByCatalogID(int catalogId, int portalID, int languageID)
        {
            List<Product> colProducts = null;
            Product Product = null;
            ...
            using (SqlConnection sqlConnection = new SqlConnection(CMSCoreBase.CMSCoreConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand(SN_PRODUCT_GET_BY_CATALOG_ID, sqlConnection);
                sqlCommand.CommandType = System.Data.CommandType.StoredProcedure;
