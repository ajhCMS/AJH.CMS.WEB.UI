...
SELECT 1, 13, 13, 1 UNION ALL
SELECT 2, 14, 13, 1 UNION ALL
SELECT 3, 15, 13, 1 UNION ALL
SELECT 4, 16, 13, 1 UNION ALL
SELECT 5, 17, 13, 1 UNION ALL
SELECT 6, 18, 13, 1 UNION ALL
SELECT 7, 19, 13, 1 UNION ALL
SELECT 8, 20, 13, 1 UNION ALL
SELECT 9, 21, 13, 1 UNION ALL
SELECT 10, 22, 13, 1 UNION ALL
SELECT 11, 23, 13, 1 UNION ALL
SELECT 12, 24, 13, 1 UNION ALL
SELECT 13, 25, 13, 1 UNION ALL
SELECT 14, 26, 13, 1 UNION ALL
SELECT 15, 27, 13, 1 UNION ALL
SELECT 16, 28, 13, 1 UNION ALL
SELECT 17, 29, 13, 1 UNION ALL
SELECT 18, 30, 13, 1 UNION ALL
SELECT 19, 31, 13, 1 UNION ALL
SELECT 20, 32, 13, 1 UNION ALL
SELECT 21, 33, 13, 1 UNION ALL
SELECT 22, 34, 13, 1 UNION ALL
SELECT 24, 36, 13, 1 UNION ALL
SELECT 25, 37, 13, 1 UNION ALL
SELECT 27, 38, 13, 1 UNION ALL
SELECT 28, 40, 13, 1 UNION ALL
SELECT 29, 41, 13, 1
COMMIT;
...
SELECT 1, N'admin', N'admin', N'fpHKOF6C32f4ZXjKnnRu7w==', 1, 8124, 69178, 0
COMMIT;
