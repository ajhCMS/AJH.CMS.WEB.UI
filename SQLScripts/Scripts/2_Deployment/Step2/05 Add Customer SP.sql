...
CREATE PROCEDURE [ECOMMERCE].[CustomerAdd]
	...
	@P_CUSTOMER_EDUCATION nvarchar(50),
	@P_CUSTOMER_POSITION nvarchar(50),
	@P_CUSTOMER_LOCATION nvarchar(50),
...
INSERT INTO [ECOMMERCE].[CUSTOMER] (
	...
	[CUSTOMER_NEWSLETTER],
	[CUSTOMER_OPT_IN],
	[CUSTOMER_USER_ID],[CUSTOMER_EDUCATION],[CUSTOMER_POSITION],[CUSTOMER_LOCATION]
...
UPDATE [ECOMMERCE].[CUSTOMER] SET
	...
	[CUSTOMER_EDUCATION]=@P_CUSTOMER_EDUCATION,
	[CUSTOMER_POSITION]= @P_CUSTOMER_POSITION,
